...
def cache_pred_cacheerr_abCov_statistic(interval, mode):
    all_cache = torch.load("./calibration/church_feature_maps_interval{}.pt".format(interval))
...
def cache_pred_quanterr_abCov_statistic(weight_bit, norm, interval, mode):
    ...
    if norm:
        ...
        group_weight, group_bias = torch.load("./error_dec/church/groupnorm_norm_params_W{}_cache{}.pth".format(args.weight_bit, args.replicate_interval))
        ...
        act_delta, act_zero_point = torch.load("./error_dec/church/act_quantizer_norm_params_aftercacheadd_W{}_cache{}.pth".format(args.weight_bit, args.replicate_interval), map_location=torch.device('cpu'))
        weight_delta, weight_zero_point = torch.load("./error_dec/church/weight_quantizer_norm_params_aftercacheadd_W{}_cache{}.pth".format(args.weight_bit, args.replicate_interval), map_location=torch.device('cpu'))
        weight, bias = torch.load("./error_dec/church/weight_norm_params_W{}_cache{}.pth".format(args.weight_bit, args.replicate_interval), map_location=torch.device('cpu'))
        ...
        act_delta, act_zero_point = torch.load("./error_dec/church/act_quantizer_params_aftercacheadd_W{}_cache{}.pth".format(args.weight_bit, args.replicate_interval), map_location=torch.device('cpu'))
        weight_delta, weight_zero_point = torch.load("./error_dec/church/weight_quantizer_params_aftercacheadd_W{}_cache{}.pth".format(args.weight_bit, args.replicate_interval), map_location=torch.device('cpu'))
        weight, bias = torch.load("./error_dec/church/weight_params_W{}_cache{}.pth".format(args.weight_bit, args.replicate_interval), map_location=torch.device('cpu'))

...
if __name__ == "__main__":
    ...
    # (a_list, b_list) = torch.load(f"./error_dec/cifar/pre_cacheerr_abCov_interval{args.replicate_interval}_list.pth")
    ...
    if args.ptq:
        ...
        # if not args.recon:  # 修复W4A8情况bug
            # pre_err_list = torch.load(f"./error_dec/cifar/pre_quanterr_abCov_weight{args.weight_bit}_interval{args.replicate_interval}_list.pth")

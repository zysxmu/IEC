...
if __name__ == "__main__":
    ...
    if args.ptq:
        ...
        torch.save((q_unet.model.output_blocks[-1][0].skip_connection.weight_quantizer.delta, q_unet.model.output_blocks[-1][0].skip_connection.weight_quantizer.zero_point), "./error_dec/church/weight_quantizer_params_aftercacheadd_W{}_cache{}.pth".format(args.weight_bit, args.replicate_interval)) #_aftercacheadd
        torch.save((q_unet.model.output_blocks[-1][0].skip_connection.act_quantizer.delta, q_unet.model.output_blocks[-1][0].skip_connection.act_quantizer.zero_point), "./error_dec/church/act_quantizer_params_aftercacheadd_W{}_cache{}.pth".format(args.weight_bit, args.replicate_interval))
        torch.save((q_unet.model.output_blocks[-1][0].skip_connection.org_weight, q_unet.model.output_blocks[-1][0].skip_connection.org_bias), "./error_dec/church/weight_params_W{}_cache{}.pth".format(args.weight_bit, args.replicate_interval))
        torch.save((q_unet.model.output_blocks[-1][0].in_layers[2].weight_quantizer.delta, q_unet.model.output_blocks[-1][0].in_layers[2].weight_quantizer.zero_point), "./error_dec/church/weight_quantizer_norm_params_aftercacheadd_W{}_cache{}.pth".format(args.weight_bit, args.replicate_interval))
        torch.save((q_unet.model.output_blocks[-1][0].in_layers[2].act_quantizer.delta, q_unet.model.output_blocks[-1][0].in_layers[2].act_quantizer.zero_point), "./error_dec/church/act_quantizer_norm_params_aftercacheadd_W{}_cache{}.pth".format(args.weight_bit, args.replicate_interval))
        torch.save((q_unet.model.output_blocks[-1][0].in_layers[2].org_weight, q_unet.model.output_blocks[-1][0].in_layers[2].org_bias), "./error_dec/church/weight_norm_params_W{}_cache{}.pth".format(args.weight_bit, args.replicate_interval))
        torch.save((q_unet.model.output_blocks[-1][0].in_layers[0].weight, q_unet.model.output_blocks[-1][0].in_layers[0].bias), "./error_dec/church/groupnorm_norm_params_W{}_cache{}.pth".format(args.weight_bit, args.replicate_interval))
